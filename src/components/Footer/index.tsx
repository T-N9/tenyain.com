...
const Footer = () => {
  return (
    <footer className="p-4 mt-20 bg-white sm:p-6 dark:bg-gray-800">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-secondary dark:text-secondary">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-secondary uppercase dark:text-white">Follow us</h2>
                    <ul className="text-secondary dark:text-secondary">
                        <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-secondary sm:text-center dark:text-secondary">© 2022 <a href="https://flowbite.com" className="hover:underline">Flowbite™</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="#" className="text-secondary hover:text-secondary dark:hover:text-white">
