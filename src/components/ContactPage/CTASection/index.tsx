    ...
    return (
        <SectionWrapper className="bg-white dark:bg-secondary pt-16">
            <div className="flex flex-col justify-center">
                <h1 className={`${chakra_petch.className} uppercase mb-14 text-4xl text-center font-extrabold tracking-tight leading-none text-primary-600 md:text-5xl lg:text-6xl dark:text-accent-600`}>
                    Open to Work
                </h1>
