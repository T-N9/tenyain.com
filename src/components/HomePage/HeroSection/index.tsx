    ...
    <section className="bg-white dark:bg-secondary">
      <div className="flex flex-col gap-y-20 lg:flex-row py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 lg:px-0">
        <div className="flex-1 relative z-10">
          ...
          <p className="text-2xl">Hello there, I am <span className="font-bold text-primary-600">Te Nyain</span></p>
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-start sm:space-y-0 sm:space-x-4">
            ...
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-secondary rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
