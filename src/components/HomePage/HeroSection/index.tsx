...
const HeroSection = () => {
  return (
    <section className="bg-white dark:bg-secondary">
      <div className="flex flex-col gap-8 md:flex-row py-8 px-4 mx-auto max-w-screen-lg text-left xl:py-16 xl:px-0 justify-between">
        ...
        <div className="">
          {/* <CharacterHead /> */}
          <Image src={'/assets/hero.jpg'} width={400} height={400} alt='Portrait of TeNyain' className='object-cover w-full lg:w-[300px] h-[400px] lg:h-[300px] border-4 border-gray-200 rounded shadow' />
        </div>
      </div>
    </section>
  )
