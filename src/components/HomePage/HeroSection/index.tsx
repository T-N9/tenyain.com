...
const HeroSection = () => {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="flex flex-col gap-y-20 lg:flex-row py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 lg:px-12">
        <div className="flex-1 relative z-10">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-5xl dark:text-white">A Front-end Developer</h1>
