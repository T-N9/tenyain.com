const LoadingArticleCard: React.FC = () => {
    return (
        <div className=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-secondary animate-pulse">
            <div className="h-[192px] lg:h-60 bg-gray-200 rounded-t-lg dark:bg-gray-700"></div>
            <div className="p-5">
                <div className="h-8 bg-gray-200 rounded dark:bg-gray-700 mb-4"></div>
                <div className="h-4 bg-gray-200 rounded dark:bg-gray-700 mb-1"></div>
                <div className="h-4 bg-gray-200 rounded dark:bg-gray-700 mb-1"></div>
                <div className="h-4 hidden lg:block bg-gray-200 rounded dark:bg-gray-700 mb-1"></div>
