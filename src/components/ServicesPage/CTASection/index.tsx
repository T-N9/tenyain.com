    ...
    return (
        <SectionWrapper className="bg-white dark:bg-secondary">
            <div className="flex flex-col justify-center">
                <h1 className={`${unbound.className} uppercase mb-4 text-4xl font-extrabold tracking-tight leading-none text-primary-600 dark:text-accent-600 md:text-5xl lg:text-6xl`}>
