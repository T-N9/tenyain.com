...
<div className='mx-auto table mb-4'>
                <a aria-label="Click to view my notes" href="https://notes.tenyain.com/" target='_blank' rel="noreferrer" className="inline-flex justify-between items-center py-1 px-1 pr-4 text-sm text-slate-600 bg-gray-100 rounded-full dark:bg-gray-600 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 duration-100 transition-all">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="mb-4">
                        ...
                        <input
                            type="email"
                            id="email"
                            className={`bg-gray-50 border ${errors.email ? '!border-red-500' : 'border-gray-300'} text-slate-600 text-lg lg:text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-secondary placeholder-gray-300 dark:placeholder-gray-500 dark:text-white dark:focus:ring-accent-500 dark:focus:border-accent-500`}
